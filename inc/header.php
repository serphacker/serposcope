...
echo"                           <li><a id='Change' href='javascript:location.reload()' title='Zmień widok podstawowy' value='".$i_value."' rel='tooltip' data-placement='bottom'><img id='btn_7' src='img/i_".$i_src.".png' /></a></li>\r\n";
...
if ($adminAcces){echo"                           <li><a href='options.php' title='Zmień ustawienia' rel='tooltip' data-placement='bottom'><img id='btn_4' src='img/setting.png' /></a></li>\r\n";}
